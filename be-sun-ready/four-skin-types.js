    ...
    <div className="container mt-4">
      <div className="row">
        ...
        <div className="col-md-3 col-sm-6 col-6 col-xs-6">
          <div className={Styles.SkinColorHolder}>
            <Image
              alt="be-sun-ready-white"
              height="307"
              src="/be-sun-ready/white.png"
              width="307"
            />
            <h4 className={Styles.SkinColorTitle}>
        ...
        <div className="col-md-3 col-sm-6 col-6 col-xs-6">
          <div className={Styles.SkinColorHolder}>
            <Image
              alt="be-sun-ready-brunette"
              height="307"
              src="/be-sun-ready/brunette.png"
              width="307"
            />
            <h4 className={Styles.SkinColorTitle}>
        ...
        <div className="col-md-3 col-sm-6 col-6 col-xs-6">
          <div className={Styles.SkinColorHolder}>
            <Image
              alt="be-sun-ready-dark"
              height="307"
              src="/be-sun-ready/dark.png"
              width="307"
            />
