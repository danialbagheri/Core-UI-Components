...
export function LogOut(props: SvgIconProps) {
  return (
    ...
    >
      <path
        d="M60.2,124.3c-0.2-0.5-0.2-0.9-0.2-1.2c0.1-0.3-0.1-0.6-0.6-0.8c-0.5-0.2-0.7-0.4-0.7-0.5c0-0.1-0.3-0.2-1-0.3
	...
	c0-0.6,0-1.4,0-2.4C60.2,125.2,60.2,124.6,60.2,124.3z"
      />
      <path
        d="M142.5,71L93.2,21.7c-1.1-1.1-2.5-1.7-4.1-1.7c-1.6,0-2.9,0.6-4.1,1.7c-1.1,1.1-1.7,2.5-1.7,4.1v26.1H42.8
